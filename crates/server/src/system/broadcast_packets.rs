...
pub fn broadcast_packets(
    ...
    encoder.par_drain(|buf| {
        ...
        //                     .packets
        //                     .writer
        //                     .send_raw(packet_data.slice(packet.offset..packet.offset +
        // packet.len))                     .is_err()
        //                 {
        //                     continue 'handle_player;
        //                 }
        ...
        //                     // In theory, this loop could keep going if the current packet is
        // large                     // and the rest of the packets are small. However, most
        // of these                     // droppable packets are small, so it's not worth it
        // to check the rest                     // of the packets.
        //                     break;
        //                 }
        //
        //                 if player
